...
public class JdbcToFile { 
    ...
    public static void main( String[] args ){
        ...
        try {
            driver1=new TeradataDriver("user1", "passwd1", jdbcClass, jdbcURL3);
            JDBCReader jdbcReader=new JDBCReader(driver1, "select * from db1.table_1", "db1.table_1", 100000, 2);
            jdbcReader.start();
            Writer writer=new FileWriter(jdbcReader.tableMeta, "com.ryan.widodo.FormattedFileWriter.OrcWriter",10000);
